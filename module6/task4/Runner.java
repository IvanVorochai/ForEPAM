...
import module6.task4.bean.Dock;
import module6.task4.bean.Port;
import module6.task4.bean.Ship;
...
//судна и вместимость порта. В порту работает несколько причалов. У одного причала может стоять один корабль. Корабль
//может загружаться у причала или разгружаться
public class Runner {
    private static final BlockingQueue<Ship> queue = new ArrayBlockingQueue<>(10);
